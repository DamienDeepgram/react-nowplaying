...
declare const NowPlayingContext: React.Context<NowPlayingContext>;
/**
 ...
 */
declare const NowPlayingContextProvider: ({ children }: NowPlayingContextInterface) => react_jsx_runtime.JSX.Element;
/**
 * Custom hook to access the NowPlaying context.
 * @returns The NowPlayingContext with audio playback control functions.
 */
declare function useNowPlaying(): NowPlayingContext;
